#!/usr/bin/env python3
"""Images analysis script - delegates to unified FMF CLI."""
...
def main() -> int:
    ...
    warnings.warn(
        "This script is deprecated. Use 'fmf images' instead.",
        DeprecationWarning,
        stacklevel=2
    )
    ...
    try:
        ...
        while i < len(args):
            ...
            if arg in ["-r", "--recipe"]:
                ...
                print("Error: Recipe mode is no longer supported. Use 'fmf images' instead.", file=sys.stderr)
                return 1
                ...
                try:
                    subprocess.run(["fmf", "images", "--help"], check=True)
