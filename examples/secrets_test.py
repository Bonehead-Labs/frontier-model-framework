#!/usr/bin/env python3
"""DataFrame analysis using FMF with AWS Secrets Manager - identical to dataframe_analyse.py but using AWS for API key."""
...
def main() -> None:
    """DataFrame analysis using AWS Secrets Manager for API key retrieval."""
    ...
    # Configure using fluent API - THIS IS THE ONLY DIFFERENCE FROM dataframe_analyse.py
    fmf = (fmf
           .with_secrets_provider("aws")  # Use AWS Secrets Manager for API key
